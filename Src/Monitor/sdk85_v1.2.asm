...
;
;        IF      1-WAITS 
IBTIM   EQU     1152    ; INTER-BIT TIME DELAY 
OBTIM   EQU     1152    ; OUTPUT INTER-BIT TIME DELAY 
TIM2    EQU     2304    ; 2 BIT TIME DELAY 
WAIT    EQU     576     ; DELAY UNTIL READY TO SAMPLE BITS 
;        ENDIF 
; 
; DELAY VALUES IF ONE WAIT STATE 
;
;        IF      WAITS 
;IBTIM   EQU     928     ; INTER-BIT DELAY 
;OBTIM   EQU     928     ; OUTPUT INTER-BIT TIME DELAY 
;TIM2    EQU     1859    ; 2 BIT TIME DELAY 
;WAIT    EQU     464     ; DELAY UNTIL READY TO SAMPLE BITS 
;        ENDIF 
;
;
;********************************************************************
...
CO05: 
        ...
        SIM 
        LXI     D,TIM2  ; WAIT OUT PARITY BIT  
        CALL    DELAY  
        POP     D  
